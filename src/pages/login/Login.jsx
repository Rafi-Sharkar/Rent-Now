        ...
        <div className={style.form}>
            ...
            <form onSubmit={handleSubmit} autoComplete='off'>
                ...
                <div className={style.flain}>
                    ...
                    <input value={values.email} onChange={handleChange} id='email' type="email" placeholder='Enter your email' className={`w-[310px] ${errors.email && touched.email ? 'border-2 border-red-600':'border-2 border-[#333]'}`}/>
                    {errors.email && touched.email && <p className='text-[.8rem] mb-[-1.2rem] text-red-400'>{errors.email}</p>}
                </div>
                <div className={style.flain}>
                    <label htmlFor="pass">Password</label> <br />
                    <input value={values.pass} onChange={handleChange} id='pass' type="password" placeholder='Enter password' className={`w-[310px] ${errors.pass && touched.pass? 'border-2 border-red-600':'border-2 border-[#333]'}`}/>
